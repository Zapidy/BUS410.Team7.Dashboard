...
## Corpus Check
- 55 files · ~1,905,766 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 540 nodes · 820 edges · 88 communities detected
...
5. `main()` - 11 edges
6. `$()` - 11 edges
7. `ensureTractLayers()` - 10 edges
8. `renderMethodology()` - 10 edges
9. `log()` - 10 edges
10. `main()` - 10 edges
...
Cohesion: 0.04
Nodes (96): abImpactByGroup(), activeFeatureCount(), activeFillLayerId(), activeGeoMeta(), activeHistogramStore(), activeHoverLayerId(), activeLeversForNote(), activePinnedLayerId() (+88 more)
...
Cohesion: 0.11
Nodes (32): aggregate_latest(), build_ablation_payload(), build_city_index(), build_ranking_payload(), _clip_prob(), county_drivers_payload(), headline_metrics(), load_county_names() (+24 more)
...
Cohesion: 0.22
Nodes (12): family(), load_panel(), main(), run_horizon(), summarize_rows(), _build_folds(), evaluate(), main() (+4 more)

### Community 5 - "Community 5"
Cohesion: 0.26
Nodes (14): applyThemeToMap(), bgColor(), computeColorExpr(), coralColor(), edgeColor(), ensureTractLayers(), hideMapLoading(), isDarkTheme() (+6 more)
...
Cohesion: 1.0
Nodes (1): Load per-tract top SHAP drivers if present.

### Community 60 - "Community 60"
Cohesion: 1.0
Nodes (1): Convert log-odds SHAP contribution to signed probability points.
...
## Knowledge Gaps
- **97 isolated node(s):** `Per tract, take the most-recent (year, fold) calibrated probability.`, `Mean across folds — the canonical AUC/AP for this project.`, `Latest non-null tract population for county weighting.`, `Load per-tract top SHAP drivers if present.`, `Convert log-odds SHAP contribution to signed probability points.` (+92 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 37`** (3 nodes): `main()`, `parse_page()`, `pull_sba_micro.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (3 nodes): `load_optional_csv()`, `main()`, `classify_lenders.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (3 nodes): `load_csv()`, `main()`, `build_round7_panel.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (3 nodes): `walk_forward_overlay.py`, `evaluate()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (3 nodes): `walk_forward_round7.py`, `evaluate()`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (3 nodes): `main()`, `parse_money()`, `build_branches.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (3 nodes): `load_demographics()`, `main()`, `build_peers.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (3 nodes): `fetch_state_year()`, `main()`, `pull_acs.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (3 nodes): `main()`, `prepare()`, `feature_importance.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (2 nodes): `410DB README — Round 7 Two-Layer Credit-Desert Risk Project`, `tracts.geojson (Dashboard Map Data)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Per tract, take the most-recent (year, fold) calibrated probability.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (1 nodes): `Mean across folds — the canonical AUC/AP for this project.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (1 nodes): `Latest non-null tract population for county weighting.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (1 nodes): `Load per-tract top SHAP drivers if present.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `Convert log-odds SHAP contribution to signed probability points.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (1 nodes): `Build city search index from Census Gazetteer + decennial place-pop API.     Fal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `Per tract, take the most-recent (year, fold) calibrated probability.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (1 nodes): `Mean across folds — the canonical AUC/AP for this project.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (1 nodes): `Latest non-null tract population for county weighting.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (1 nodes): `Build city search index from Census Gazetteer + decennial place-pop API.     Fal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `Per tract, take the most-recent (year, fold) calibrated probability.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (1 nodes): `Mean across folds — the canonical AUC/AP for this project.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (1 nodes): `Build city search index from Census Gazetteer + decennial place-pop API.     Fal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (1 nodes): `Per tract, take the most-recent (year, fold) calibrated probability.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (1 nodes): `Mean across folds — the canonical AUC/AP for this project.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (1 nodes): `Build city search index from Census Gazetteer + decennial place-pop API.     Fal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `tract_lender_year.csv (CRA Apportioned)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (1 nodes): `lender_class.csv (Lender Flags)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `cra_to_rssd.csv (RSSD-CRA Crosswalk)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (1 nodes): `mdi_list.csv (MDI Roster)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (1 nodes): `cdfi_list.csv (CDFI Certified List)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (1 nodes): `microlender_list.csv (SBA Microlender List)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `FDIC Institutions CSV (RSSD/CERT)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (1 nodes): `assets_by_year.csv (FDIC Call Report)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (1 nodes): `cdfi_geocoded.csv (CDFI with lat/lon)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (1 nodes): `microlender_geocoded.csv (Microlenders with lat/lon)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (1 nodes): `tract_centroids_2020.csv (Census TIGER)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (1 nodes): `state_year_ssbci.csv (SSBCI Overlay)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (1 nodes): `tract_year_with_target_round7.parquet (Training Panel)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (1 nodes): `test_predictions.parquet (Walk-Forward Predictions)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `FDIC BankFind API (External)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Census Geocoder API (External)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `Nominatim (OpenStreetMap) Geocoder`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `FFIEC CRA Disclosure Flat Files (D1/D6)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (1 nodes): `FDIC Summary of Deposits (SoD)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (1 nodes): `Target: Becomes Service Desert (h+3/h+6)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (1 nodes): `web/README.md — Dashboard Build and Data Documentation`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (1 nodes): `00_design_brief.md — Round 7 Design Brief and Feature Tiers`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (1 nodes): `05_methodology_brief.md — Methodology Brief`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `log()` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `logit()` connect `Community 0` to `Community 2`?**
